package dev.stone.practice.profile.data;
...
public class ProfileKitData {
    ...
    public void fromBson(Document document) {
        ...
        loadouts = Phantom.getGson().fromJson(document.getString("loadouts"), KitLoadout[].class);
    }
    ...
    public Document toBson() {
        return new Document()
                ...
                .append("loadouts", Phantom.getGson().toJson(loadouts))
                ;
    }
