...
import dev.stone.practice.arena.ArenaGrid;
import dev.stone.practice.arena.ArenaHandler;
import dev.stone.practice.arena.ArenaSchematic;
import dev.stone.practice.commands.PotPvPCommand;
import dev.stone.practice.util.CC;
import dev.stone.practice.util.LocationUtils;
...
public class ArenaCommands implements PotPvPCommand {
  ...
  /*  private static final String[] HELP_MESSAGE = {
    ...
    public void arenaFree(@Sender Player sender) {
        Phantom.getInstance().getArenaHandler().getGrid().free();
    ...
    public void arenaRescaleAll(@Sender Player sender) {
        Phantom.getInstance().getArenaHandler().getSchematics().forEach(schematic -> {
            ArenaHandler arenaHandler = Phantom.getInstance().getArenaHandler();
