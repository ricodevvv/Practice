...
public class Team {
    ...
    public void teleport(Location location) {
        if (!location.getChunk().isLoaded()) {
            Common.debug( CC.RED + "The block has not been loaded yet, but the system is teleporting the player to that location. This may cause server lag. Please fix it as soon as possible.");
        }
        for (TeamPlayer teamPlayer : getTeamPlayers()) {
